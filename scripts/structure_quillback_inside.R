...
path <- "/project/ctb-grego/ntbsykes/copper_quillback/vcf/inside_quillback/combined.quillback.inside."
...
for (k in 1:10){
  data <- read.delim(paste0("/project/ctb-grego/ntbsykes/copper_quillback/structure/quillback_inside/combined.quillback.inside.",k,".Q"),
                     header = FALSE,
...
#pdf(file = "plots/admixture_quillback.pdf", width = 4, height = 2)
#png(file = "quillback_admixture.png", width = 3500, height = 2000, res = 300)
plot_3 <- quillback_admix %>%
...
quillback_cv <- read_lines("/project/ctb-grego/ntbsykes/copper_quillback/structure/quillback_inside/quillback.cv.error") %>%
  tibble(text = .) %>%
...
pdf("/project/ctb-grego/ntbsykes/copper_quillback/plots/admixture_quillback_inside.pdf",
    height=8,width=9)
