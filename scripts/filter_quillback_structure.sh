...
path_out="/project/ctb-grego/ntbsykes/copper_quillback/vcf/structure"
...
bcftools view temp_quillback_${out}_3 \
	-i 'INFO/ExcHet>0.007' \
	-O b > ${path_out}/quillback_${out}_structure.bcf

bcftools index ${path_out}/quillback_${out}_structure.bcf
