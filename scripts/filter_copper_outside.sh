...
path_out="/project/ctb-grego/ntbsykes/copper_quillback/vcf/outside_copper"
path_meta="/project/ctb-grego/ntbsykes/copper_quillback/meta"

# subset species
bcftools view ${path_in}/${chr} \
	-S ${path_meta}/copper_outside.txt \
...
bcftools view temp_copper_${out}_3 \
	-i 'INFO/ExcHet>0.007' \
	-O b > ${path_out}/copper_${out}_outside.bcf

bcftools index ${path_out}/copper_${out}_outside.bcf
