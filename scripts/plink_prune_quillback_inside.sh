...
vcf_in="/project/ctb-grego/ntbsykes/copper_quillback/vcf/inside_quillback/combined.quillback.inside.vcf.gz"
out="/project/ctb-grego/ntbsykes/copper_quillback/structure/quillback_inside/combined.quillback.inside"
