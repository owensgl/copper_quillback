...
vcf_in="/project/ctb-grego/ntbsykes/copper_quillback/vcf/structure/maf02/quillback_combined_maf02.bcf"
out="/project/ctb-grego/ntbsykes/copper_quillback/structure/quillback_maf02"
