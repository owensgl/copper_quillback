...
vcf_in="/project/ctb-grego/ntbsykes/copper_quillback/vcf/structure/genome_hic_combined.bcf"
out="/project/ctb-grego/ntbsykes/copper_quillback/structure/combined"
