...
path <- "/project/ctb-grego/ntbsykes/copper_quillback/vcf/outside_quillback/combined.quillback.outside."
...
for (k in 1:10){
  data <- read.delim(paste0("/project/ctb-grego/ntbsykes/copper_quillback/structure/quillback_outside/combined.quillback.outside.",k,".Q"),
                     header = FALSE,
...
quillback_cv <- read_lines("/project/ctb-grego/ntbsykes/copper_quillback/structure/quillback_outside/quillback.cv.error") %>%
  tibble(text = .) %>%
...
pdf("/project/ctb-grego/ntbsykes/copper_quillback/plots/admixture_quillback_outside.pdf",
    height=8,width=9)
