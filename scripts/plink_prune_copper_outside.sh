...
vcf_in="/project/ctb-grego/ntbsykes/copper_quillback/vcf/outside_copper/combined.copper.outside.vcf.gz"
out="/project/ctb-grego/ntbsykes/copper_quillback/structure/copper_outside/combined.copper.outside"
