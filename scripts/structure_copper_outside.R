...
path <- "/project/ctb-grego/ntbsykes/copper_quillback/vcf/outside_copper/combined.copper.outside."
...
for (k in 1:10){
  data <- read.delim(paste0("/project/ctb-grego/ntbsykes/copper_quillback/structure/copper_outside/combined.copper.outside.",k,".Q"),
                     header = FALSE,
...
pdf("/project/ctb-grego/ntbsykes/copper_quillback/plots/admixture_copper_outside.pdf",
    height=8,width=9)
