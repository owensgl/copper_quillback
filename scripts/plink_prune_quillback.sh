...
vcf_in="/project/ctb-grego/ntbsykes/copper_quillback/vcf/structure/quillback_combined.bcf"
out="/project/ctb-grego/ntbsykes/copper_quillback/structure/quillback"
